...
import io.github.boniu.util.JsonUtil;
...
public class EasyExcelUtil {
     ...
     */
    public static <T> Map<Integer, String> importExcel(MultipartFile file, Class<T> cl, EasyExcelListener<T> listener) {
        try {
    ...
    public static <T> Map<Integer, String> importExcel(File file, Class<T> cl, EasyExcelListener<T> listener) {
        try {
            FileInputStream fileInputStream = new FileInputStream(file);
            EasyExcel.read(fileInputStream, cl, listener).sheet().doRead();
            return listener.getErrorMessageMap();
        } catch (IOException e) {
            return null;
        }
